-- Migrate categories from mockData.ts to Supabase with Qatar labeling
...
-- Get category IDs for menu items insertion
DO $$
DECLARE
...
-- Update site_config to ensure Qatar labeling is clear
UPDATE site_config SET 
    country_code = 'qa',
    country_name = 'Qatar', 
    website_name = 'Panda Cakes Qatar',
    currency_code = 'QAR',
    currency_symbol = 'ر.ق',
...
-- Insert Qatar site config if it doesn't exist
INSERT INTO site_config (country_code, country_name, website_name, currency_code, currency_symbol, phone_country_code, default_timezone, is_active) 
VALUES ('qa', 'Qatar', 'Panda Cakes Qatar', 'QAR', 'ر.ق', '+974', 'Asia/Qatar', true)
