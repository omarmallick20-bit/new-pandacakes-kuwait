    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-tiffany hover:bg-tiffany/90 text-background" disabled={isLoading || !termsAccepted || formData.fullName.trim().length === 0 || formData.password.length < 6}>
