...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-tiffany/60 text-white hover:bg-tiffany/70 enabled:bg-tiffany-active enabled:hover:bg-tiffany-active/90 disabled:opacity-100",
        destructive:
        ...
        sunshine: "bg-tiffany/60 text-white hover:bg-tiffany/70 enabled:bg-tiffany-active enabled:hover:bg-tiffany-active/90 font-semibold shadow-lg disabled:opacity-100",
        hero: "bg-tiffany/60 text-white hover:bg-tiffany/70 enabled:bg-tiffany-active enabled:hover:bg-tiffany-active/90 font-bold text-lg px-8 py-4 rounded-xl shadow-xl disabled:opacity-100",
      },
      size: {
